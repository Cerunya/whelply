...
export default function BreederContactSidebar({
  ...
  themeColor, themeAccentColor, verband, verificationLevel,
      ...
      <div>
        ...
        {(verband || (verificationLevel && verificationLevel !== 'none')) && (
          <div className="flex items-center gap-2 flex-wrap mt-1.5">
            {verband && (
              <span className="text-xs font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-cream border border-cream-deep text-stone-600">
                {verband}
              </span>
            )}
