        ...
        {url ? (
          ...
          <div className="p-6 text-center w-48">
            ...
            <p className="text-xs text-stone-500">
              {uploading ? (<><svg className="w-4 h-4 animate-spin mr-1.5 inline" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"/></svg>Wird hochgeladen …</>) : 'Profilbild hochladen'}
            </p>
          </div>
        )}
      </div>
