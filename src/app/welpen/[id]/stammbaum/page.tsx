...
export default async function StammbaumPage({
  ...
  function GrandCard({ dog, role, color }: { dog: { id: string; name: string; slug?: string | null } | null; role: string; color: 'pink' | 'blue' }) {
    if (!dog) return (
  ...
  function GreatCard({ dog, role }: { dog: { id: string; name: string; slug?: string | null } | null; role: string }) {
    if (!dog) return (
            ...
            <>
              ...
              <>
                ...
                <div className="grid grid-cols-8 gap-2">
                  ...
                  ] as [{ id: string; name: string; slug?: string | null } | null, string][]).map(([dog, role], i) => (
