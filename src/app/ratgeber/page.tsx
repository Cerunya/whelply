      ...
      <main className="min-h-screen bg-cream">
        <section className="bg-forest px-4 py-12">
          <div className="max-w-6xl mx-auto">
            <p className="text-white/60 text-xs font-semibold uppercase tracking-widest mb-2">Wissen & Tipps</p>
            <h1 className="font-serif text-3xl font-bold text-white mb-2">Ratgeber</h1>
            <p className="text-white/70 text-sm">
              Alles rund um Hundezucht, Welpenkauf und das Leben mit Hund — von Experten für Hundeliebhaber.
            </p>
          </div>
        </section>
